...
# Ruta al archivo CSV
csv_file = r'C:\Users\aviei\Documents\Parkings Dubai\Imagenes\Umm_Al_Quwain.csv'  # Cambia esto a la ubicación de tu archivo CSV

# Ruta de destino para guardar las imágenes
destination_folder = r'C:\Users\aviei\Documents\Parkings Dubai\Imagenes\UmmAlQuwain'
