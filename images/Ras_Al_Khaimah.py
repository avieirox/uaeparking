...
# Ruta al archivo CSV
csv_file = r'C:\Users\aviei\Documents\Parkings Dubai\Imagenes\Ras_Al_Khaimah.csv'  # Cambia esto a la ubicación de tu archivo CSV

# Ruta de destino para guardar las imágenes
destination_folder = r'C:\Users\aviei\Documents\Parkings Dubai\Imagenes\RasAlKhaimah'
